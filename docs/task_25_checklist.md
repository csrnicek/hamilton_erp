...
14. ✅ DONE — `docs/decisions_log.md` (current per PR #103 ship 2026-05-01; DEC-064 most recent)
15. ✅ DONE — `docs/lessons_learned.md` (current per PR #84 audit; LL-001 → LL-037)
